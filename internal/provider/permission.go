...
//below pemission works only for 1.0 nonprod environment

// func ProdFullPermission() ([]string, error) {
// 	return []string{
...
func NonprodFullPermission() ([]string, error) {
	return []string{}, nil
}

// Scope for Teammate Developer Access
func DeveloperPermission() ([]string, error) {
	return []string{
		"alerts.create",
		"alerts.read",
		"alerts.update",
...
// func BillPermission() ([]string, error) {
// 	return []string{
// 		"billing.create",
// 		"billing.delete",
// 		"billing.read",
...
// Scope for apiKey creation
func CustomPermission() ([]string, error) {
	return []string{
		"mail.send",
		"mail.batch.create",
		"mail.batch.read",
